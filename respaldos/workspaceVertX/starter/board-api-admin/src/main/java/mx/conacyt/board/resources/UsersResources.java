...
public class UsersResources {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(UsersResources.class);
	...
	public Router getAPISubRouter(Vertx vertx) {
		...
		apiSubRouter.route("/v1/users*").handler(BodyHandler.create());
		apiSubRouter.post("/v1/users/auth").handler(this::authUser);
		apiSubRouter.get("/v1/users").handler(this::getAllProducts);
		apiSubRouter.get("/v1/users/:id").handler(this::getProductById);
		apiSubRouter.post("/v1/users").handler(this::addProduct);
		apiSubRouter.put("/v1/users/:id").handler(this::updateProductById);
		apiSubRouter.delete("/v1/users/:id").handler(this::deleteProductById);
